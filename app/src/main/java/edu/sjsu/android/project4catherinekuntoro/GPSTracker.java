...
public class GPSTracker implements OnSuccessListener<Location> {
    ...
    // check if “access location” permissions are given.
    ...
    // request the permission, where 100 is the permission code.
    ...
    public void onSuccess(Location location) {
        if (location != null) {
            ...
            Toast.makeText(context, "Catherine Kuntoro is at \n" +
                            "Lat " + latitude + "\nLong: " + longitude,
    ...
    public void getLocation() {
        ...
        if (!isLocationEnabled()) {
            ...
            provider.getLastLocation().addOnSuccessListener(this);
        }
    }
}
